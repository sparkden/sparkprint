 ...
 */
// Models we can slice + print today. H2-series (dual-nozzle) are excluded until H2 slicing lands.
export const CLOUD_PRINTABLE_MODELS = ['X1', 'X1C', 'X1E', 'P1S', 'P1P', 'A1', 'A1M'] as const;
