<script lang="ts" module>
	// Lucide-style 24x24 stroke icons. Add paths as needed.
	export const ICONS: Record<string, string> = {
		printer:
			'M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2M6 14h12v8H6z',
		layers: 'm12 2 9 5-9 5-9-5 9-5ZM3 12l9 5 9-5M3 17l9 5 9-5',
		palette:
			'M12 22a10 10 0 1 1 0-20c5.5 0 10 3.6 10 8 0 3-2.4 4-4.5 4H15a2 2 0 0 0-1.5 3.3A2 2 0 0 1 12 22Z M7.5 10.5h.01M11 7.5h.01M15.5 8.5h.01',
		users:
		...
		gauge: 'M12 14l4-4M3.3 14a9 9 0 1 1 17.4 0',
		...
		spool: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20ZM12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM8 6h8',
...
<script lang="ts">
	let {
		...
		stroke = 2,
		class: klass = ''
	}: { name: keyof typeof ICONS | string; size?: number; stroke?: number; class?: string } =
		$props();
